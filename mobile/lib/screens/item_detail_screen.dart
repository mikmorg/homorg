...
import 'barcode_sheet.dart';
import 'camera_capture_screen.dart';
import 'container_picker_sheet.dart';
  ...
  Future<void> _showMovePicker() async {
    final result = await showModalBottomSheet<PickerResult>(
      ...
      builder: (ctx) => DraggableScrollableSheet(
        ...
        maxChildSize: 0.9,
        expand: false,
        builder: (ctx, scrollController) => ContainerPickerSheet(
          api: widget.api,
  ...
  Future<void> _showBarcodeSheet() async {
    ...
    await showModalBottomSheet(
      ...
      builder: (ctx) => DraggableScrollableSheet(
        ...
        maxChildSize: 0.85,
        expand: false,
        builder: (ctx, scrollController) => BarcodeSheet(
          api: widget.api,
...
// ── Moved to container_picker_sheet.dart ───────────────────────────
